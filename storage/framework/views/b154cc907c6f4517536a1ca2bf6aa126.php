...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .sidebar-chat { 
            width: 100% !important; 
            display: <?php echo e(request('user_id') ? 'none' : 'flex'); ?>; 
        }
        .main-chat { 
            width: 100% !important; 
            display: <?php echo e(request('user_id') ? 'flex' : 'none'); ?>; 
        }
    ...
    <div class="chat-container">
        ...
        <div class="sidebar-chat">
            ...
            <div class="no-scrollbar" style="flex: 1; overflow-y: auto;">
                ...
                <a href="<?php echo e(route('messages')); ?>" style="display: block; padding: 18px 25px; text-decoration: none; border-bottom: 1px solid #f8fafc; <?php echo e(!request('user_id') ? 'background: #f8fafc; border-left: 4px solid #2563eb;' : ''); ?>">
                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="?user_id=<?php echo e($user->id); ?>" style="display: block; padding: 18px 25px; text-decoration: none; border-bottom: 1px solid #f8fafc; transition: 0.2s; <?php echo e(request('user_id') == $user->id ? 'background: #f8fafc; border-left: 4px solid #2563eb;' : ''); ?>">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="color: #1e293b; font-weight: 600; font-size: 14px;"><?php echo e($user->name); ?></span>
                            <?php if($user->latestMessage): ?>
                                <span style="color: #94a3b8; font-size: 10px; font-weight: 600;"><?php echo e($user->latestMessage->created_at->format('H:i')); ?></span>
                            <?php endif; ?>
                        </div>
                        <p style="color: #64748b; font-size: 11px; margin: 4px 0 0 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 400;">
                            <?php echo e($user->latestMessage ? $user->latestMessage->content : 'Aucun message récent'); ?>
        ...
        <div class="main-chat">
            ...
            <div style="padding: 18px 25px; border-bottom: 1px solid #f1f5f9; background: #fff; display: flex; align-items: center; gap: 15px;">
                ...
                <a href="<?php echo e(route('messages')); ?>" class="md:hidden" style="text-decoration: none; color: #2563eb; font-size: 20px; font-weight: bold;">
                ...
                <div>
                    <h3 style="color: #0f172a; font-weight: 800; text-transform: uppercase; font-size: 13px; margin: 0;"><?php echo e($chatTitle); ?></h3>
            ...
            <div id="chat-box" class="no-scrollbar" style="flex: 1; padding: 25px; overflow-y: auto; display: flex; flex-direction: column; gap: 20px; background: #fdfdfd;">
                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="display: flex; <?php echo e($msg->user_id == auth()->id() ? 'justify-content: flex-end;' : 'justify-content: flex-start;'); ?>">
                        <div class="message-bubble <?php echo e($msg->user_id == auth()->id() ? 'msg-sent' : 'msg-received'); ?>">
                            <?php if(!request('user_id') && $msg->user_id != auth()->id()): ?>
                                <div style="font-size: 10px; font-weight: 800; color: #2563eb; text-transform: uppercase; margin-bottom: 6px;"><?php echo e($msg->user->name); ?></div>
                            <?php endif; ?>
                            
                            <div style="word-wrap: break-word;"><?php echo e($msg->content); ?></div>
                            
                            <?php if($msg->document_path): ?>
                                <div style="margin-top: 10px; padding: 10px; background: rgba(0,0,0,0.05); border-radius: 10px; border: 1px solid rgba(0,0,0,0.05);">
                                    <a href="<?php echo e(asset('storage/' . $msg->document_path)); ?>" target="_blank" style="color: inherit; font-size: 10px; font-weight: 800; text-decoration: none; display: flex; align-items: center; gap: 8px;">
                                        📎 DOCUMENT JOINT
                                    </a>
                                </div>
                            <?php endif; ?>
            ...
            <div style="padding: 20px 25px; background: #fff; border-top: 1px solid #f1f5f9;">
                <form action="<?php echo e(route('messages.store')); ?>" method="POST" style="display: flex; gap: 12px; align-items: center;">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="receiver_id" value="<?php echo e(request('user_id', 0)); ?>">
                    <input type="hidden" name="is_group_message" value="<?php echo e(request('user_id') ? '0' : '1'); ?>">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\empreinte\resources\views/pages/messages.blade.php ENDPATH**/ ?>