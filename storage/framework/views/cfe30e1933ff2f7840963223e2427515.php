...
<div class="min-h-screen py-4 md:py-8 px-4 md:px-0 max-w-5xl mx-auto space-y-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-5 shadow-xl shadow-slate-200/50 rounded-[24px] flex items-center justify-between border-l-[6px] <?php echo e($stat[3]); ?> border-t border-r border-b border-slate-100 transition-transform hover:scale-[1.03]">
            <div class="space-y-1">
            ...
            <div class="w-10 h-10 bg-slate-50 flex items-center justify-center rounded-xl border border-slate-100 flex-shrink-0">
                <i class="fas <?php echo e($stat[2]); ?> <?php echo e($stat[4]); ?> text-lg"></i>
            </div>
        </div>
                ...
                <div class="group flex flex-col md:flex-row md:items-center justify-between p-4 md:p-6 bg-white shadow-lg shadow-slate-200/40 rounded-[28px] border-l-[8px] <?php echo e($borderColor); ?> border-t border-r border-b border-slate-100 transition-all <?php echo e($isMe ? 'ring-2 ring-blue-500/5' : ''); ?>">
                    ...
                    <div class="flex items-center gap-4 flex-1">
                        ...
                        <div class="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-slate-50 rounded-2xl border border-slate-100 shadow-inner">
                            ...
                            <?php else: ?> <span class="text-sm font-black text-slate-400">#<?php echo e($index + 1); ?></span>
                            <?php endif; ?>
                        </div>

                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-1">
                                <a href="<?php echo e(route('collaborator.show', $user)); ?>" class="text-sm md:text-base font-black uppercase tracking-tight text-slate-900 hover:text-blue-600 truncate">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-[11px] font-black text-slate-900"><?php echo e($score); ?>%</span>
                            </div>
                        </div>
                    </div>
